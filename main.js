...
// 1. Tính tổng thời gian của tất cả các bài hát

// function totalDuration(theSongsList) {
//     let count = 0;
//     for(let i = 0; i < theSongsList.length; i++) {
//       count =(count + (theSongsList[i].duration));
//     }
//     return count;
//   }

//   console.log(totalDuration(theSongs));

// 2. chọn tên 1 ca sĩ và in ra các bài hát của ca sĩ đó. (HIEUTHUHAI)

// function gettheSongOfHTH (theSongsList) {
//      const title = [];
//      for (let i = 0; i < theSongsList.length; i++) {
//         if(theSongsList[i].artists == "HIEUTHUHAI"){
//             title.push(theSongsList[i].title);
//   }
// }   
//   return title;

// }
// console.log(gettheSongOfHTH(theSongs));

// 3. chọn tên 1 distributor và in ra các bài hát của distributor đó. (MIXUS)

// function gettheSongOfMIXUS (theSongsList) {
//      const distributor  = [];
//      for (let i = 0; i < theSongsList.length; i++) {
//       if(theSongsList[i].distributor === "MIXUS"){
//         distributor.push(theSongsList[i].title);
//       }
//     }   
//       return distributor;
    
//     }
//     console.log(gettheSongOfMIXUS(theSongs));

// 4. Bài hát nào có nhiều hơn 1 ca sĩ thì in ra title và artists

// function getSongMorethanOArtist (theSongsList) {
//      const moreThanOne  = [];
//      for (let i = 0; i < theSongsList.length; i++) {
//       if(theSongsList[i].artists.length > 1 ){
//         moreThanOne.push(theSongsList[i].title);
//         moreThanOne.push(theSongsList[i].artists);
//       }
//     }   
//       return moreThanOne;
    
//     }
//     console.log(getSongMorethanOArtist(theSongs));

// 5. Viết hàm tạo ra 1 mảng mới chỉ chứa các bài hát indie.

// function getttheIndieSongs (theSongsList) {
//      const indieSongs  = [];
//      for (let i = 0; i < theSongsList.length; i++) {
//       if(theSongsList[i].isIndie == true){
//         indieSongs.push(theSongsList[i].title);
//       }
//     }   
//       return indieSongs;
    
//     }
//     console.log(getttheIndieSongs (theSongs));
// 
// 6. Viết hàm tạo ra 1 mảng mới chỉ chứa các bài hát có lyrics.
// function gettsongsHaveLyrics (theSongsList) {
//     const hasLyric  = [];
//     for (let i = 0; i < theSongsList.length; i++) {
//      if(theSongsList[i].hasLyric == true){
//         hasLyric.push(theSongsList[i].title);
//      }
//    }   
//      return hasLyric;
   
//    }
//    console.log(gettsongsHaveLyrics (theSongs));


// 7. Viết hàm lấy mảng và thời lượng tối thiểu làm đầu vào rồi trả về title, duration của bài hát nào dài hơn thời lượng đó.(duration< 200)

// function getDurationLower200(productList) {
//   const duration = [];
//   for (let i = 0; i < productList.length; i++) {
//     if (productList[i].duration < 200) {
//         duration.push(productList[i].title);
//         duration.push(productList[i].duration);
//     }
//   }
//   return duration;
// }
// console.log(getDurationLower200(theSongs));

// 8. Chọn 1 title rồi in ra mảng chứa title đó 

// function gettheSong(productList) {
//    let result  = [];
//    for (let i = 0; i < productList.length; i++) {
//     if(productList[i].title === "Cắt Đôi Nỗi Sầu") {
...
//   }
//   console.log((gettheSong(theSongs)));